...
uint32_t nnode = 50;
  ...
  double th[] = {6.5, 7.2, 13.5, 15.0, 13.0, 14.4, 27.0, 30.0, 19.5, 21.7, 40.5, 45.0, 26.0, 28.9, 54.0, 60.0, 39.0, 43.3, 81.0, 90.0, 52.0, 57.8, 108.0, 120.0, 58.5, 65.0, 121.5, 135.0, 65.0, 72.2, 135.0, 150.0}; //send 
    int   CWmin = 15;      //31
    int   CWmax = 1023;    //1023
//string phymod[] = {"HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs12", "HtMcs13", "HtMcs14", "HtMcs15", "HtMcs16", "HtMcs17", "HtMcs18", "HtMcs19", "HtMcs20", "HtMcs21", "HtMcs22", "HtMcs23", "HtMcs24", "HtMcs25", "HtMcs26", "HtMcs27", "HtMcs28", "HtMcs29", "HtMcs30", "HtMcs31"}; //send 
  string ControlMode[] = {"HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3", "HtMcs0", "HtMcs1", "HtMcs2", "HtMcs3"}; //send 
  string DataMode[] =    {"HtMcs0", "HtMcs0", "HtMcs0", "HtMcs0", "HtMcs1", "HtMcs1", "HtMcs1", "HtMcs1", "HtMcs2", "HtMcs2", "HtMcs2", "HtMcs2", "HtMcs3", "HtMcs3", "HtMcs3", "HtMcs3", "HtMcs4", "HtMcs4", "HtMcs4", "HtMcs4", "HtMcs5", "HtMcs5", "HtMcs5", "HtMcs5", "HtMcs6", "HtMcs6", "HtMcs6", "HtMcs6", "HtMcs7", "HtMcs7", "HtMcs7", "HtMcs7"};
...
int th_it = -1;
for(int CWvalue = 716; CWvalue < 1001; ++CWvalue){
CWmin = CWmax = CWvalue;
  for (int i = 0; i <= 0; i++) //MCS do 7
    {
      for (int j = 20; j <= 20; ) //channel width
        {
          for (int k = 1; k < 2; k++) //GI: 0 and 1     800 potem 400
            {
